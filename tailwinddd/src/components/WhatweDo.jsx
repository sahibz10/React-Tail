...
// Features data ko ek array mein define kiya gaya hai.
const features = [
  {
  ...
  },
  {
    ...
    icon: (
      // SVG icon
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-blue-600 mr-4 flex-shrink-0">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.104c.73-.147 1.474-.271 2.226-.393M17.25 18.75H4.5m15.75 0H218.75a60.07 60.07 0 0115.797 2.104c.73-.147 1.474-.271 2.226-.393M17.25 18.75H4.5m15.75 0H218.75a60.07 60.07 0 0115.797 2.104c.73-.147-1.474-.271-2.226-.393M18.75 18.75v-12.375m0 0a3.75 3.75 0 10-7.5 0M18.75 18.75H4.5m15.75 0a60.07 60.07 0 01-15.797 2.104c-.73-.147-1.474-.271-2.226-.393m0 0v-5.25m0 0a3.75 3.75 0 10-7.5 0M18.75 18.75v-12.375m0 0a3.75 3.75 0 10-7.5 0" />
      </svg>
    ),
  },
  {
    ...
    <section className="container mx-auto px-6 py-16 md:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          {/* features array par map karke har feature ko render kiya gaya hai. */}
        ...
        <div className="flex justify-center lg:justify-end">
          <img 
            src={yourImage} // Yahan  apni image lagai h.
